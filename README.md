...
- [SDCC-NOINIT](https://github.com/salextpuru/sdcc-noinit) - оптимизированная версия SDCC библиотек
- [EVO SDK](http://alonecoder.nedopc.com/zx/index.html) - SDK для разработки игр
